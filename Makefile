...
ES_RESOURCES = $(if $(elasticsearch_urls), elasticsearch_urls=$(elasticsearch_urls)) $(if $(elasticSearchHostname), elasticSearchHostname=$(elasticSearchHostname)) $(if $(elasticsearch_index), elasticsearch_index=$(elasticsearch_index))
