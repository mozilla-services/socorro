...
The ``BreakpadStackwalkerRule2015`` processor rule runs a stackwalker that
operates on minidump files generated by Breakpad to extract information about
the process. The stackwalker is run as a subprocess.
