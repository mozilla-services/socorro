...
def report_index(request, crash_id, default_context=None):
    ...
    if not valid_crash_id:
        return CrashstatsHttpResponseBadRequest('Invalid crash ID')
...
def report_list(request, partial=None, default_context=None):
    ...
    if duration.days > max_query_range:
        return CrashstatsHttpResponseBadRequest('range duration too long')
...
def plot_signature(request, product, versions, start_date, end_date,
    ...
    try:
        ...
        return CrashstatsHttpResponseBadRequest(str(msg))

    if not signature:
        return CrashstatsHttpResponseBadRequest('signature is required')
