...
from sqlalchemy.orm import relationshipship
...
'BuildAdu',
'Correlationship',
'CorrelationshipAddon',
'CorrelationshipCore',
'CorrelationshipModule',
'CrashType',
'CrashesByUser',
'CrashesByUserBuild',
'CrontabberState',
...
'Signature',
'SignatureProduct',
'SignatureProductsRollup',
'SocorroDbVersion',
'SocorroDbVersionHistory',
'SpecialProductPlatform',
'Tcbs',
'TcbsBuild',
'TransformRule',
'UptimeLevel',
...
correlationship_addons = Table(u'correlationship_addons', metadata,
    Column(u'correlationship_id', INTEGER(), ForeignKey('correlationships.correlationship_id'), nullable=False),
...
correlationship_cores = Table(u'correlationship_cores', metadata,
    Column(u'correlationship_id', INTEGER(), ForeignKey('correlationships.correlationship_id'), nullable=False),
...
correlationship_modules = Table(u'correlationship_modules', metadata,
    Column(u'correlationship_id', INTEGER(), ForeignKey('correlationships.correlationship_id'), nullable=False),
...
class Correlationship(DeclarativeBase):
    __tablename__ = 'correlationships'

    __table_args__ = {}

    #column definitions
    correlationship_id = Column(u'correlationship_id', INTEGER(), primary_key=True, nullable=False)
...
class CorrelationshipAddon(DeclarativeBase):
    __tablename__ = 'correlationship_addons'

    # column definitions
    correlationship_id = Column(u'correlationship_id', INTEGER(), nullable=False)
...
class CorrelationshipCore(DeclarativeBase):
    __tablename__ = 'correlationship_cores'
...
class CorrelationshipModule(DeclarativeBase):
    __tablename__ = 'correlationship_module'
