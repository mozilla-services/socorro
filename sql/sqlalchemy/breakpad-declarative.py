...
from sqlalchemy.ext.declarative import declarative_base from sqlalchemy.orm import relation engine = create_engine('postgres://selena:death@localhost/breakpad')
...
class ReleaseChannel(DeclarativeBase):
    ...
    signatures = relation('Signature', primaryjoin='ReleaseChannel.release_channel==Tcbs.release_channel', secondary=tcbs, secondaryjoin='Tcbs.signature_id==Signature.signature_id')
...
class Signature(DeclarativeBase):
    ...
    release_channels = relation('ReleaseChannel', primaryjoin='Signature.signature_id==Tcbs.signature_id', secondary=tcbs, secondaryjoin='Tcbs.release_channel==ReleaseChannel.release_channel')
...
class Tcbs(DeclarativeBase):
    ...
    #relation definitions
    release_channels = relation('ReleaseChannel', primaryjoin='Tcbs.release_channel==ReleaseChannel.release_channel')
    signatures = relation('Signature', primaryjoin='Tcbs.signature_id==Signature.signature_id')
