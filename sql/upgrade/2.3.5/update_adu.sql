...
FROM product_versions
	LEFT OUTER JOIN raw_adu
		ON product_versions.product_name = 
			COALESCE(product_productid_map.product_name, raw_adu.product_name)::citext
    ...
    LEFT OUTER JOIN product_productid_map
    	ON raw_adu.product_guid = product_productid_map.productid
