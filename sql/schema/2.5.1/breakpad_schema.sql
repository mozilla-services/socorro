...
--
-- Name: priority_jobs_2398; Type: TABLE; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE TABLE priority_jobs_2398 (
    uuid character varying(50) NOT NULL
);


ALTER TABLE public.priority_jobs_2398 OWNER TO breakpad_rw;
...
--
-- Name: priority_jobs_2398_pkey; Type: CONSTRAINT; Schema: public; Owner: breakpad_rw; Tablespace: 
--

ALTER TABLE ONLY priority_jobs_2398
    ADD CONSTRAINT priority_jobs_2398_pkey PRIMARY KEY (uuid);
...
--
-- Name: priority_jobs_2398; Type: ACL; Schema: public; Owner: breakpad_rw
--

REVOKE ALL ON TABLE priority_jobs_2398 FROM PUBLIC;
REVOKE ALL ON TABLE priority_jobs_2398 FROM breakpad_rw;
GRANT ALL ON TABLE priority_jobs_2398 TO breakpad_rw;
GRANT SELECT ON TABLE priority_jobs_2398 TO breakpad;
