...
--
-- Name: frames_20120402; Type: TABLE; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE TABLE frames_20120402 (
    CONSTRAINT frames_20120402_date_check CHECK ((('2012-04-02 00:00:00+00'::timestamp with time zone <= date_processed) AND (date_processed < '2012-04-09 00:00:00+00'::timestamp with time zone)))
)
INHERITS (frames);


ALTER TABLE public.frames_20120402 OWNER TO breakpad_rw;
...
--
-- Name: priority_jobs_2374; Type: TABLE; Schema: public; Owner: processor; Tablespace: 
--

CREATE TABLE priority_jobs_2374 (
    uuid character varying(50) NOT NULL
);


ALTER TABLE public.priority_jobs_2374 OWNER TO processor;

--
-- Name: priority_jobs_2375; Type: TABLE; Schema: public; Owner: processor; Tablespace: 
--

CREATE TABLE priority_jobs_2375 (
    uuid character varying(50) NOT NULL
);


ALTER TABLE public.priority_jobs_2375 OWNER TO processor;

--
-- Name: priority_jobs_2376; Type: TABLE; Schema: public; Owner: processor; Tablespace: 
--

CREATE TABLE priority_jobs_2376 (
    uuid character varying(50) NOT NULL
);


ALTER TABLE public.priority_jobs_2376 OWNER TO processor;
...
--
-- Name: frames_20120402_pkey; Type: CONSTRAINT; Schema: public; Owner: breakpad_rw; Tablespace: 
--

ALTER TABLE ONLY frames_20120402
    ADD CONSTRAINT frames_20120402_pkey PRIMARY KEY (report_id, frame_num);
...
--
-- Name: priority_jobs_2374_pkey; Type: CONSTRAINT; Schema: public; Owner: processor; Tablespace: 
--

ALTER TABLE ONLY priority_jobs_2374
    ADD CONSTRAINT priority_jobs_2374_pkey PRIMARY KEY (uuid);


--
-- Name: priority_jobs_2375_pkey; Type: CONSTRAINT; Schema: public; Owner: processor; Tablespace: 
--

ALTER TABLE ONLY priority_jobs_2375
    ADD CONSTRAINT priority_jobs_2375_pkey PRIMARY KEY (uuid);


--
-- Name: priority_jobs_2376_pkey; Type: CONSTRAINT; Schema: public; Owner: processor; Tablespace: 
--

ALTER TABLE ONLY priority_jobs_2376
    ADD CONSTRAINT priority_jobs_2376_pkey PRIMARY KEY (uuid);
...
--
-- Name: frames_20120402_report_id_date_key; Type: INDEX; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE INDEX frames_20120402_report_id_date_key ON frames_20120402 USING btree (report_id, date_processed);
...
--
-- Name: frames_20120402_report_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: breakpad_rw
--

ALTER TABLE ONLY frames_20120402
    ADD CONSTRAINT frames_20120402_report_id_fkey FOREIGN KEY (report_id) REFERENCES reports_20120402(id) ON DELETE CASCADE;
...
--
-- Name: frames_20120402; Type: ACL; Schema: public; Owner: breakpad_rw
--

REVOKE ALL ON TABLE frames_20120402 FROM PUBLIC;
REVOKE ALL ON TABLE frames_20120402 FROM breakpad_rw;
GRANT ALL ON TABLE frames_20120402 TO breakpad_rw;
GRANT SELECT ON TABLE frames_20120402 TO breakpad;
...
--
-- Name: priority_jobs_2374; Type: ACL; Schema: public; Owner: processor
--

REVOKE ALL ON TABLE priority_jobs_2374 FROM PUBLIC;
REVOKE ALL ON TABLE priority_jobs_2374 FROM processor;
GRANT ALL ON TABLE priority_jobs_2374 TO processor;
GRANT ALL ON TABLE priority_jobs_2374 TO breakpad_rw;


--
-- Name: priority_jobs_2375; Type: ACL; Schema: public; Owner: processor
--

REVOKE ALL ON TABLE priority_jobs_2375 FROM PUBLIC;
REVOKE ALL ON TABLE priority_jobs_2375 FROM processor;
GRANT ALL ON TABLE priority_jobs_2375 TO processor;
GRANT ALL ON TABLE priority_jobs_2375 TO breakpad_rw;


--
-- Name: priority_jobs_2376; Type: ACL; Schema: public; Owner: processor
--

REVOKE ALL ON TABLE priority_jobs_2376 FROM PUBLIC;
REVOKE ALL ON TABLE priority_jobs_2376 FROM processor;
GRANT ALL ON TABLE priority_jobs_2376 TO processor;
GRANT ALL ON TABLE priority_jobs_2376 TO breakpad_rw;
