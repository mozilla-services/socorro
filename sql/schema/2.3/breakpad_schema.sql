...
--
-- Name: backfill_adu(date, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION backfill_adu(updateday date, forproduct text DEFAULT ''::text) RETURNS boolean
    LANGUAGE plpgsql
...
ALTER FUNCTION public.backfill_adu(updateday date, forproduct text) OWNER TO postgres;
...
--
-- Name: backfill_daily_crashes(date, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION backfill_daily_crashes(updateday date, forproduct text DEFAULT ''::text) RETURNS boolean
    LANGUAGE plpgsql
    SET work_mem TO '512MB'
    SET temp_buffers TO '512MB'
    AS $$
...
ALTER FUNCTION public.backfill_daily_crashes(updateday date, forproduct text) OWNER TO postgres;
...
--
-- Name: backfill_matviews(date, text, date, boolean); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION backfill_matviews(firstday date, forproduct text DEFAULT ''::text, lastday date DEFAULT NULL::date, reportsclean boolean DEFAULT true) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
...
ALTER FUNCTION public.backfill_matviews(firstday date, forproduct text, lastday date, reportsclean boolean) OWNER TO postgres;
...
--
-- Name: backfill_tcbs(date, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION backfill_tcbs(updateday date, forproduct text DEFAULT ''::text) RETURNS boolean
    LANGUAGE plpgsql
    SET work_mem TO '512MB'
    SET temp_buffers TO '512MB'
    AS $$
...
ALTER FUNCTION public.backfill_tcbs(updateday date, forproduct text) OWNER TO postgres;
...
--
-- Name: ts2pacific(timestamp without time zone); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION ts2pacific(timestamp without time zone) RETURNS timestamp with time zone
    LANGUAGE sql STABLE
    AS $_$
...
ALTER FUNCTION public.ts2pacific(timestamp without time zone) OWNER TO postgres;
...
--
-- Name: tz2pac_ts(timestamp with time zone); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION tz2pac_ts(timestamp with time zone) RETURNS timestamp without time zone
    LANGUAGE sql STABLE
    AS $_$
SELECT $1 AT TIME ZONE 'America/Los_Angeles';
$_$;
...
ALTER FUNCTION public.tz2pac_ts(timestamp with time zone) OWNER TO postgres;
...
--
-- Name: week_begins_utc(timestamp without time zone); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION week_begins_utc(timestamp without time zone) RETURNS timestamp with time zone
    LANGUAGE sql STABLE
    SET "TimeZone" TO 'UTC'
    AS $_$
...
ALTER FUNCTION public.week_begins_utc(timestamp without time zone) OWNER TO postgres;
...
CREATE TABLE extensions_20111121 (
    CONSTRAINT extensions_20111121_date_check CHECK ((('2011-11-21 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-11-28 00:00:00'::timestamp without time zone)))
)
INHERITS (extensions);
...
CREATE TABLE extensions_20111128 (
    CONSTRAINT extensions_20111128_date_check CHECK ((('2011-11-28 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-12-05 00:00:00'::timestamp without time zone)))
)
INHERITS (extensions);
...
CREATE TABLE extensions_20111205 (
    CONSTRAINT extensions_20111205_date_check CHECK ((('2011-12-05 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-12-12 00:00:00'::timestamp without time zone)))
)
INHERITS (extensions);
...
CREATE TABLE extensions_20111212 (
    CONSTRAINT extensions_20111212_date_check CHECK ((('2011-12-12 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-12-19 00:00:00'::timestamp without time zone)))
)
INHERITS (extensions);
...
CREATE TABLE extensions_20111219 (
    CONSTRAINT extensions_20111219_date_check CHECK ((('2011-12-19 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-12-26 00:00:00'::timestamp without time zone)))
)
INHERITS (extensions);
...
CREATE TABLE extensions_20111226 (
    CONSTRAINT extensions_20111226_date_check CHECK ((('2011-12-26 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2012-01-02 00:00:00'::timestamp without time zone)))
)
INHERITS (extensions);
...
CREATE TABLE extensions_20120102 (
    CONSTRAINT extensions_20120102_date_check CHECK ((('2012-01-02 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2012-01-09 00:00:00'::timestamp without time zone)))
)
INHERITS (extensions);
...
CREATE TABLE extensions_20120109 (
    CONSTRAINT extensions_20120109_date_check CHECK ((('2012-01-09 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2012-01-16 00:00:00'::timestamp without time zone)))
)
INHERITS (extensions);
...
--
-- Name: frames_20111121; Type: TABLE; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE TABLE frames_20111121 (
    CONSTRAINT frames_20111121_date_check CHECK ((('2011-11-21 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-11-28 00:00:00'::timestamp without time zone)))
)
INHERITS (frames);


ALTER TABLE public.frames_20111121 OWNER TO breakpad_rw;

--
-- Name: frames_20111128; Type: TABLE; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE TABLE frames_20111128 (
    CONSTRAINT frames_20111128_date_check CHECK ((('2011-11-28 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-12-05 00:00:00'::timestamp without time zone)))
)
INHERITS (frames);


ALTER TABLE public.frames_20111128 OWNER TO breakpad_rw;

--
-- Name: frames_20111205; Type: TABLE; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE TABLE frames_20111205 (
    CONSTRAINT frames_20111205_date_check CHECK ((('2011-12-05 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-12-12 00:00:00'::timestamp without time zone)))
)
INHERITS (frames);


ALTER TABLE public.frames_20111205 OWNER TO breakpad_rw;

--
-- Name: frames_20111212; Type: TABLE; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE TABLE frames_20111212 (
    CONSTRAINT frames_20111212_date_check CHECK ((('2011-12-12 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-12-19 00:00:00'::timestamp without time zone)))
)
INHERITS (frames);


ALTER TABLE public.frames_20111212 OWNER TO breakpad_rw;

--
-- Name: frames_20111219; Type: TABLE; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE TABLE frames_20111219 (
    CONSTRAINT frames_20111219_date_check CHECK ((('2011-12-19 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-12-26 00:00:00'::timestamp without time zone)))
)
INHERITS (frames);


ALTER TABLE public.frames_20111219 OWNER TO breakpad_rw;

--
-- Name: frames_20111226; Type: TABLE; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE TABLE frames_20111226 (
    CONSTRAINT frames_20111226_date_check CHECK ((('2011-12-26 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2012-01-02 00:00:00'::timestamp without time zone)))
)
INHERITS (frames);


ALTER TABLE public.frames_20111226 OWNER TO breakpad_rw;

--
-- Name: frames_20120102; Type: TABLE; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE TABLE frames_20120102 (
    CONSTRAINT frames_20120102_date_check CHECK ((('2012-01-02 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2012-01-09 00:00:00'::timestamp without time zone)))
)
INHERITS (frames);


ALTER TABLE public.frames_20120102 OWNER TO breakpad_rw;

--
-- Name: frames_20120109; Type: TABLE; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE TABLE frames_20120109 (
    CONSTRAINT frames_20120109_date_check CHECK ((('2012-01-09 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2012-01-16 00:00:00'::timestamp without time zone)))
)
INHERITS (frames);


ALTER TABLE public.frames_20120109 OWNER TO breakpad_rw;
...
--
-- Name: hang_report; Type: VIEW; Schema: public; Owner: postgres
--
...
ALTER TABLE public.hang_report OWNER TO postgres;
...
CREATE TABLE plugins_reports_20111121 (
    CONSTRAINT plugins_reports_20111121_date_check CHECK ((('2011-11-21 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-11-28 00:00:00'::timestamp without time zone)))
)
...
CREATE TABLE plugins_reports_20111128 (
    CONSTRAINT plugins_reports_20111128_date_check CHECK ((('2011-11-28 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-12-05 00:00:00'::timestamp without time zone)))
)
INHERITS (plugins_reports);
...
CREATE TABLE plugins_reports_20111205 (
    CONSTRAINT plugins_reports_20111205_date_check CHECK ((('2011-12-05 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-12-12 00:00:00'::timestamp without time zone)))
)
INHERITS (plugins_reports);
...
CREATE TABLE plugins_reports_20111212 (
    CONSTRAINT plugins_reports_20111212_date_check CHECK ((('2011-12-12 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-12-19 00:00:00'::timestamp without time zone)))
)
INHERITS (plugins_reports);
...
CREATE TABLE plugins_reports_20111219 (
    CONSTRAINT plugins_reports_20111219_date_check CHECK ((('2011-12-19 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-12-26 00:00:00'::timestamp without time zone)))
)
INHERITS (plugins_reports);
...
CREATE TABLE plugins_reports_20111226 (
    CONSTRAINT plugins_reports_20111226_date_check CHECK ((('2011-12-26 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2012-01-02 00:00:00'::timestamp without time zone)))
)
INHERITS (plugins_reports);
...
CREATE TABLE plugins_reports_20120102 (
    CONSTRAINT plugins_reports_20120102_date_check CHECK ((('2012-01-02 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2012-01-09 00:00:00'::timestamp without time zone)))
)
INHERITS (plugins_reports);
...
CREATE TABLE plugins_reports_20120109 (
    CONSTRAINT plugins_reports_20120109_date_check CHECK ((('2012-01-09 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2012-01-16 00:00:00'::timestamp without time zone)))
)
INHERITS (plugins_reports);
...
--
-- Name: priority_jobs_1983; Type: TABLE; Schema: public; Owner: processor; Tablespace: 
--

CREATE TABLE priority_jobs_1983 (
    uuid character varying(50) NOT NULL
);


ALTER TABLE public.priority_jobs_1983 OWNER TO processor;

--
-- Name: priority_jobs_1984; Type: TABLE; Schema: public; Owner: processor; Tablespace: 
--

CREATE TABLE priority_jobs_1984 (
    uuid character varying(50) NOT NULL
);


ALTER TABLE public.priority_jobs_1984 OWNER TO processor;

--
-- Name: priority_jobs_1985; Type: TABLE; Schema: public; Owner: processor; Tablespace: 
--

CREATE TABLE priority_jobs_1985 (
    uuid character varying(50) NOT NULL
);


ALTER TABLE public.priority_jobs_1985 OWNER TO processor;

--
-- Name: priority_jobs_1986; Type: TABLE; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE TABLE priority_jobs_1986 (
    uuid character varying(50) NOT NULL
);


ALTER TABLE public.priority_jobs_1986 OWNER TO breakpad_rw;
...
CREATE TABLE reports_20111121 (
    CONSTRAINT reports_20111121_date_check CHECK ((('2011-11-21 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-11-28 00:00:00'::timestamp without time zone)))
)
INHERITS (reports);
...
CREATE TABLE reports_20111128 (
    CONSTRAINT reports_20111128_date_check CHECK ((('2011-11-28 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-12-05 00:00:00'::timestamp without time zone)))
)
INHERITS (reports);
...
CREATE TABLE reports_20111205 (
    CONSTRAINT reports_20111205_date_check CHECK ((('2011-12-05 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-12-12 00:00:00'::timestamp without time zone)))
)
INHERITS (reports);
...
CREATE TABLE reports_20111212 (
    CONSTRAINT reports_20111212_date_check CHECK ((('2011-12-12 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-12-19 00:00:00'::timestamp without time zone)))
)
INHERITS (reports);
...
CREATE TABLE reports_20111219 (
    CONSTRAINT reports_20111219_date_check CHECK ((('2011-12-19 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2011-12-26 00:00:00'::timestamp without time zone)))
)
INHERITS (reports);
...
CREATE TABLE reports_20111226 (
    CONSTRAINT reports_20111226_date_check CHECK ((('2011-12-26 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2012-01-02 00:00:00'::timestamp without time zone)))
)
INHERITS (reports);
...
CREATE TABLE reports_20120102 (
    CONSTRAINT reports_20120102_date_check CHECK ((('2012-01-02 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2012-01-09 00:00:00'::timestamp without time zone)))
)
INHERITS (reports);
...
CREATE TABLE reports_20120109 (
    CONSTRAINT reports_20120109_date_check CHECK ((('2012-01-09 00:00:00'::timestamp without time zone <= date_processed) AND (date_processed < '2012-01-16 00:00:00'::timestamp without time zone)))
)
INHERITS (reports);
...
--
-- Name: frames_20111121_pkey; Type: CONSTRAINT; Schema: public; Owner: breakpad_rw; Tablespace: 
--

ALTER TABLE ONLY frames_20111121
    ADD CONSTRAINT frames_20111121_pkey PRIMARY KEY (report_id, frame_num);


--
-- Name: frames_20111128_pkey; Type: CONSTRAINT; Schema: public; Owner: breakpad_rw; Tablespace: 
--

ALTER TABLE ONLY frames_20111128
    ADD CONSTRAINT frames_20111128_pkey PRIMARY KEY (report_id, frame_num);


--
-- Name: frames_20111205_pkey; Type: CONSTRAINT; Schema: public; Owner: breakpad_rw; Tablespace: 
--

ALTER TABLE ONLY frames_20111205
    ADD CONSTRAINT frames_20111205_pkey PRIMARY KEY (report_id, frame_num);


--
-- Name: frames_20111212_pkey; Type: CONSTRAINT; Schema: public; Owner: breakpad_rw; Tablespace: 
--

ALTER TABLE ONLY frames_20111212
    ADD CONSTRAINT frames_20111212_pkey PRIMARY KEY (report_id, frame_num);


--
-- Name: frames_20111219_pkey; Type: CONSTRAINT; Schema: public; Owner: breakpad_rw; Tablespace: 
--

ALTER TABLE ONLY frames_20111219
    ADD CONSTRAINT frames_20111219_pkey PRIMARY KEY (report_id, frame_num);


--
-- Name: frames_20111226_pkey; Type: CONSTRAINT; Schema: public; Owner: breakpad_rw; Tablespace: 
--

ALTER TABLE ONLY frames_20111226
    ADD CONSTRAINT frames_20111226_pkey PRIMARY KEY (report_id, frame_num);


--
-- Name: frames_20120102_pkey; Type: CONSTRAINT; Schema: public; Owner: breakpad_rw; Tablespace: 
--

ALTER TABLE ONLY frames_20120102
    ADD CONSTRAINT frames_20120102_pkey PRIMARY KEY (report_id, frame_num);


--
-- Name: frames_20120109_pkey; Type: CONSTRAINT; Schema: public; Owner: breakpad_rw; Tablespace: 
--

ALTER TABLE ONLY frames_20120109
    ADD CONSTRAINT frames_20120109_pkey PRIMARY KEY (report_id, frame_num);
...
--
-- Name: priority_jobs_1983_pkey; Type: CONSTRAINT; Schema: public; Owner: processor; Tablespace: 
--

ALTER TABLE ONLY priority_jobs_1983
    ADD CONSTRAINT priority_jobs_1983_pkey PRIMARY KEY (uuid);


--
-- Name: priority_jobs_1984_pkey; Type: CONSTRAINT; Schema: public; Owner: processor; Tablespace: 
--

ALTER TABLE ONLY priority_jobs_1984
    ADD CONSTRAINT priority_jobs_1984_pkey PRIMARY KEY (uuid);


--
-- Name: priority_jobs_1985_pkey; Type: CONSTRAINT; Schema: public; Owner: processor; Tablespace: 
--

ALTER TABLE ONLY priority_jobs_1985
    ADD CONSTRAINT priority_jobs_1985_pkey PRIMARY KEY (uuid);


--
-- Name: priority_jobs_1986_pkey; Type: CONSTRAINT; Schema: public; Owner: breakpad_rw; Tablespace: 
--

ALTER TABLE ONLY priority_jobs_1986
    ADD CONSTRAINT priority_jobs_1986_pkey PRIMARY KEY (uuid);
...
--
-- Name: frames_20111121_report_id_date_key; Type: INDEX; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE INDEX frames_20111121_report_id_date_key ON frames_20111121 USING btree (report_id, date_processed);


--
-- Name: frames_20111128_report_id_date_key; Type: INDEX; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE INDEX frames_20111128_report_id_date_key ON frames_20111128 USING btree (report_id, date_processed);


--
-- Name: frames_20111205_report_id_date_key; Type: INDEX; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE INDEX frames_20111205_report_id_date_key ON frames_20111205 USING btree (report_id, date_processed);


--
-- Name: frames_20111212_report_id_date_key; Type: INDEX; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE INDEX frames_20111212_report_id_date_key ON frames_20111212 USING btree (report_id, date_processed);


--
-- Name: frames_20111219_report_id_date_key; Type: INDEX; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE INDEX frames_20111219_report_id_date_key ON frames_20111219 USING btree (report_id, date_processed);


--
-- Name: frames_20111226_report_id_date_key; Type: INDEX; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE INDEX frames_20111226_report_id_date_key ON frames_20111226 USING btree (report_id, date_processed);


--
-- Name: frames_20120102_report_id_date_key; Type: INDEX; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE INDEX frames_20120102_report_id_date_key ON frames_20120102 USING btree (report_id, date_processed);


--
-- Name: frames_20120109_report_id_date_key; Type: INDEX; Schema: public; Owner: breakpad_rw; Tablespace: 
--

CREATE INDEX frames_20120109_report_id_date_key ON frames_20120109 USING btree (report_id, date_processed);
...
--
-- Name: frames_20111121_report_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: breakpad_rw
--

ALTER TABLE ONLY frames_20111121
    ADD CONSTRAINT frames_20111121_report_id_fkey FOREIGN KEY (report_id) REFERENCES reports_20111121(id) ON DELETE CASCADE;


--
-- Name: frames_20111128_report_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: breakpad_rw
--

ALTER TABLE ONLY frames_20111128
    ADD CONSTRAINT frames_20111128_report_id_fkey FOREIGN KEY (report_id) REFERENCES reports_20111128(id) ON DELETE CASCADE;


--
-- Name: frames_20111205_report_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: breakpad_rw
--

ALTER TABLE ONLY frames_20111205
    ADD CONSTRAINT frames_20111205_report_id_fkey FOREIGN KEY (report_id) REFERENCES reports_20111205(id) ON DELETE CASCADE;


--
-- Name: frames_20111212_report_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: breakpad_rw
--

ALTER TABLE ONLY frames_20111212
    ADD CONSTRAINT frames_20111212_report_id_fkey FOREIGN KEY (report_id) REFERENCES reports_20111212(id) ON DELETE CASCADE;


--
-- Name: frames_20111219_report_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: breakpad_rw
--

ALTER TABLE ONLY frames_20111219
    ADD CONSTRAINT frames_20111219_report_id_fkey FOREIGN KEY (report_id) REFERENCES reports_20111219(id) ON DELETE CASCADE;


--
-- Name: frames_20111226_report_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: breakpad_rw
--

ALTER TABLE ONLY frames_20111226
    ADD CONSTRAINT frames_20111226_report_id_fkey FOREIGN KEY (report_id) REFERENCES reports_20111226(id) ON DELETE CASCADE;


--
-- Name: frames_20120102_report_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: breakpad_rw
--

ALTER TABLE ONLY frames_20120102
    ADD CONSTRAINT frames_20120102_report_id_fkey FOREIGN KEY (report_id) REFERENCES reports_20120102(id) ON DELETE CASCADE;


--
-- Name: frames_20120109_report_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: breakpad_rw
--

ALTER TABLE ONLY frames_20120109
    ADD CONSTRAINT frames_20120109_report_id_fkey FOREIGN KEY (report_id) REFERENCES reports_20120109(id) ON DELETE CASCADE;
...
--
-- Name: frames_20111121; Type: ACL; Schema: public; Owner: breakpad_rw
--

REVOKE ALL ON TABLE frames_20111121 FROM PUBLIC;
REVOKE ALL ON TABLE frames_20111121 FROM breakpad_rw;
GRANT ALL ON TABLE frames_20111121 TO breakpad_rw;
GRANT SELECT ON TABLE frames_20111121 TO breakpad;


--
-- Name: frames_20111128; Type: ACL; Schema: public; Owner: breakpad_rw
--

REVOKE ALL ON TABLE frames_20111128 FROM PUBLIC;
REVOKE ALL ON TABLE frames_20111128 FROM breakpad_rw;
GRANT ALL ON TABLE frames_20111128 TO breakpad_rw;
GRANT SELECT ON TABLE frames_20111128 TO breakpad;


--
-- Name: frames_20111205; Type: ACL; Schema: public; Owner: breakpad_rw
--

REVOKE ALL ON TABLE frames_20111205 FROM PUBLIC;
REVOKE ALL ON TABLE frames_20111205 FROM breakpad_rw;
GRANT ALL ON TABLE frames_20111205 TO breakpad_rw;
GRANT SELECT ON TABLE frames_20111205 TO breakpad;


--
-- Name: frames_20111212; Type: ACL; Schema: public; Owner: breakpad_rw
--

REVOKE ALL ON TABLE frames_20111212 FROM PUBLIC;
REVOKE ALL ON TABLE frames_20111212 FROM breakpad_rw;
GRANT ALL ON TABLE frames_20111212 TO breakpad_rw;
GRANT SELECT ON TABLE frames_20111212 TO breakpad;


--
-- Name: frames_20111219; Type: ACL; Schema: public; Owner: breakpad_rw
--

REVOKE ALL ON TABLE frames_20111219 FROM PUBLIC;
REVOKE ALL ON TABLE frames_20111219 FROM breakpad_rw;
GRANT ALL ON TABLE frames_20111219 TO breakpad_rw;
GRANT SELECT ON TABLE frames_20111219 TO breakpad;


--
-- Name: frames_20111226; Type: ACL; Schema: public; Owner: breakpad_rw
--

REVOKE ALL ON TABLE frames_20111226 FROM PUBLIC;
REVOKE ALL ON TABLE frames_20111226 FROM breakpad_rw;
GRANT ALL ON TABLE frames_20111226 TO breakpad_rw;
GRANT SELECT ON TABLE frames_20111226 TO breakpad;


--
-- Name: frames_20120102; Type: ACL; Schema: public; Owner: breakpad_rw
--

REVOKE ALL ON TABLE frames_20120102 FROM PUBLIC;
REVOKE ALL ON TABLE frames_20120102 FROM breakpad_rw;
GRANT ALL ON TABLE frames_20120102 TO breakpad_rw;
GRANT SELECT ON TABLE frames_20120102 TO breakpad;


--
-- Name: frames_20120109; Type: ACL; Schema: public; Owner: breakpad_rw
--

REVOKE ALL ON TABLE frames_20120109 FROM PUBLIC;
REVOKE ALL ON TABLE frames_20120109 FROM breakpad_rw;
GRANT ALL ON TABLE frames_20120109 TO breakpad_rw;
GRANT SELECT ON TABLE frames_20120109 TO breakpad;
...
--
-- Name: hang_report; Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON TABLE hang_report FROM PUBLIC;
REVOKE ALL ON TABLE hang_report FROM postgres;
GRANT ALL ON TABLE hang_report TO postgres;
...
--
-- Name: priority_jobs_1983; Type: ACL; Schema: public; Owner: processor
--

REVOKE ALL ON TABLE priority_jobs_1983 FROM PUBLIC;
REVOKE ALL ON TABLE priority_jobs_1983 FROM processor;
GRANT ALL ON TABLE priority_jobs_1983 TO processor;
GRANT ALL ON TABLE priority_jobs_1983 TO breakpad_rw;


--
-- Name: priority_jobs_1984; Type: ACL; Schema: public; Owner: processor
--

REVOKE ALL ON TABLE priority_jobs_1984 FROM PUBLIC;
REVOKE ALL ON TABLE priority_jobs_1984 FROM processor;
GRANT ALL ON TABLE priority_jobs_1984 TO processor;
GRANT ALL ON TABLE priority_jobs_1984 TO breakpad_rw;


--
-- Name: priority_jobs_1985; Type: ACL; Schema: public; Owner: processor
--

REVOKE ALL ON TABLE priority_jobs_1985 FROM PUBLIC;
REVOKE ALL ON TABLE priority_jobs_1985 FROM processor;
GRANT ALL ON TABLE priority_jobs_1985 TO processor;
GRANT ALL ON TABLE priority_jobs_1985 TO breakpad_rw;


--
-- Name: priority_jobs_1986; Type: ACL; Schema: public; Owner: breakpad_rw
--

REVOKE ALL ON TABLE priority_jobs_1986 FROM PUBLIC;
REVOKE ALL ON TABLE priority_jobs_1986 FROM breakpad_rw;
GRANT ALL ON TABLE priority_jobs_1986 TO breakpad_rw;
GRANT SELECT ON TABLE priority_jobs_1986 TO breakpad;
