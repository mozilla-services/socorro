...
from socorro.external.legacy_es.search_common import SearchBase
from socorro.external.legacy_es.super_search_fields import get_search_key
...
class LegacySuperSearch(SearchBase):
