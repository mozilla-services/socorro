...
[[[BreakpadStackwalkerRule2015]]]
    ...
    # the path where the symbol cache is found, this location must be readable and writeable (quote
...
"wrapped_object_class":
    ...
    # fully qualified classname
    rule_class=socorro.external.statsd.statsd_base.StatsdBenchmarkingWrapper
