...
#==============================================================================
class ServerStatus(PostgreSQLWebServiceBase):
    ...
    def get(self, **kwargs):
        ...
        sql = """
    /* socorro.external.postgresql.server_status_service.ServerStatus.get */
            SELECT
                id,
    ...
    /* socorro.external.postgresql.server_status_service.ServerStatus.get */
        ...
        if results:
            ...
            self.config.logger.warning(
                "No version_num was found in table alembic_version"
            )
