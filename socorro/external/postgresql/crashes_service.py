...
from socorro.external.postgresql.tcbs import two_period_top_crasher_comparison
...
#==============================================================================
class Crashes(CrashesReportSearchWebServiceBase):
    ...
    def get_signatures(self, **kwargs):
        ...
        params = external_common.parse_arguments(filters, kwargs)
        params.logger = self.config.logger
        ...
        return self.transaction(two_period_top_crasher_comparison, params)
