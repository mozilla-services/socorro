...
#==============================================================================
class LagLog(PostgreSQLWebServiceBase):
    ...
    def get(self, **kwargs):
        ...
        sql = """
            /* socorro.external.postgresql.laglog_service.LagLog.get */
            SELECT
                replica_name,
                lag,
                moment,
        ...
        max_bytes_critical = self.config.max_bytes_critical
        max_bytes_warning = self.config.max_bytes_warning
