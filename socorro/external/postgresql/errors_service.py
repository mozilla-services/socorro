...
#==============================================================================
class Errors(PostgreSQLWebServiceBase):
    '''Implement the /errors services with PostgreSQL. '''

    uri = '/who/knows/what/this/web/service/is/for'
    ...
    def get_signatures(self, **kwargs):
        ...
        # TODO: WARNING: the variable 'search_mode' is NOT used
        # why are we doing this?  What is really supposed to be happening
        # here?
