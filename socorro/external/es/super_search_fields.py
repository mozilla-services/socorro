...
FIELDS = {
    ...
    "total_page_file": {
        ...
        "namespace": "raw_crash",
        "permissions_needed": [],
        "source_key": "processed_crash.total_page_file",
        "destination_keys": [
            "raw_crash.TotalPageFile",
            "processed_crash.total_page_file",
        ],
        "query_type": "number",
        "storage_mapping": {"type": "long"},
    },
    "total_physical_memory": {
        ...
        "namespace": "raw_crash",
        "permissions_needed": [],
        "source_key": "processed_crash.total_physical_memory",
        "destination_keys": [
            "raw_crash.TotalPhysicalMemory",
            "processed_crash.total_physical_memory",
        ],
        "query_type": "number",
        "storage_mapping": {"type": "long"},
    },
    "total_virtual_memory": {
        ...
        "namespace": "raw_crash",
        "permissions_needed": [],
        "source_key": "processed_crash.total_virtual_memory",
        "destination_keys": [
            "raw_crash.TotalVirtualMemory",
            "processed_crash.total_virtual_memory",
        ],
        "query_type": "number",
        "storage_mapping": {"type": "long"},
    },
