...
PUBLIC_PROCESSED_CRASH_FIELDS = {
    ...
    "json_dump.crash_info.possible_bit_flips.[].details.poison_registers",
    ...
    "upload_file_minidump_browser.json_dump.crash_info.possible_bit_flips.[].details.poison_registers",
