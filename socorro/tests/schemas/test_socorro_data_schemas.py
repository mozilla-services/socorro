...
PUBLIC_PROCESSED_CRASH_FIELDS = {
    ...
    "json_dump.crash_info.possible_bit_flips.[]",
    "json_dump.crash_info.possible_bit_flips.[].address",
    "json_dump.crash_info.possible_bit_flips.[].confidence",
    "json_dump.crash_info.possible_bit_flips.[].details",
    "json_dump.crash_info.possible_bit_flips.[].details.is_null",
    "json_dump.crash_info.possible_bit_flips.[].details.nearby_registers",
    "json_dump.crash_info.possible_bit_flips.[].details.posion_registers",
    "json_dump.crash_info.possible_bit_flips.[].details.was_low",
    "json_dump.crash_info.possible_bit_flips.[].details.was_non_canonical",
    "json_dump.crash_info.possible_bit_flips.[].source_register",
    ...
    "upload_file_minidump_browser.json_dump.crash_info.possible_bit_flips.[]",
    "upload_file_minidump_browser.json_dump.crash_info.possible_bit_flips.[].address",
    "upload_file_minidump_browser.json_dump.crash_info.possible_bit_flips.[].confidence",
    "upload_file_minidump_browser.json_dump.crash_info.possible_bit_flips.[].details",
    "upload_file_minidump_browser.json_dump.crash_info.possible_bit_flips.[].details.is_null",
    "upload_file_minidump_browser.json_dump.crash_info.possible_bit_flips.[].details.nearby_registers",
    "upload_file_minidump_browser.json_dump.crash_info.possible_bit_flips.[].details.posion_registers",
    "upload_file_minidump_browser.json_dump.crash_info.possible_bit_flips.[].details.was_low",
    "upload_file_minidump_browser.json_dump.crash_info.possible_bit_flips.[].details.was_non_canonical",
    "upload_file_minidump_browser.json_dump.crash_info.possible_bit_flips.[].source_register",
