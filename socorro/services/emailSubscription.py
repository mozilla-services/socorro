...
class EmailSubscription(webapi.JsonServiceBase):
  ...
  #-----------------------------------------------------------------------------------------------------------------
  # GET
  # curl http://localhost:8085/201009/email/subscription/e8aaa82c-c762-11df-a2ce-001cc4d80ee4
  "/201009/email/subscription/{token}"
  #
  # POST (status can be 'true' or 'false'
  #  curl -v -F token=e8aaa82c-c762-11df-a2ce-001cc4d80ee4 -F status=false \
  #             http://localhost:8085/201009/email/subscription/e8aaa82c-c762-11df-a2ce-001cc4d80ee4
  uri = '/201009/email/subscription/(.*)'
