...
class TestUtil(unittest.TestCase):
  ...
  def testGetDefaultDateInterval(self):
    ...
    assert_raises(SystemExit,cron_util.getDefaultDateInterval,cursor,self.tableName,initialDeltaDate,defaultDeltaWindow,me.fileLogger)
    ...
    ddi = cron_util.getDefaultDateInterval(cursor,self.tableName,initialDeltaDate,defaultDeltaWindow,me.fileLogger)
