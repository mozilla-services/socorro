...
def setup_mocked_s3_storage(
    tmpdir=None, storage_class=BotoS3CrashStorage, bucket_name="crash_storage", **extra
):
    values_source = {
    ...
    config = get_config(cls=storage_class, values_source=values_source)
...
class TestBotoS3CrashStorage(object):
    ...
    def test_save_raw_and_processed(self, boto_helper):
        ...
        assert boto_helper.list(bucket_name="crash_storage") == [
