...
from socorro.external.filesystem.crash_data_service import CrashData
...
class IntegrationTestCrashData(TestCase):
    ...
    def setUp(self):
        ...
        overrides = {
            'resource.filesystem.std_fs_root': self.std_tmp_dir,
            'resource.filesystem.def_fs_root': self.def_tmp_dir,
            'resource.filesystem.pro_fs_root': self.pro_tmp_dir,
        }
