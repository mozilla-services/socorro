...
from socorro.external.postgresql.signature_summary_service import (
    SignatureSummary
)
...
class IntegrationTestSignatureSummary(PostgreSQLTestCase):
    ...
    def _insert_test_data(self, connection):
        ...
        other_product_version_id = single_value_sql(
            connection,
            """
            SELECT product_version_id
            FROM product_versions
        ...
        graphics_device_id = single_value_sql(
            connection,
            """
