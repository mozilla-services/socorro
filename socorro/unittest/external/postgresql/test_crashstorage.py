        ...
        with config_manager.context() as config:
            ...
            expected_execute_args = (
                ...
                (('delete from  extensions_20120402 where report_id = %s',
                    (666, )),),
                (('insert into extensions_20120402     (report_id, uuid, date_processed, extension_key, extension_id,      extension_version)values (%s, %s, %s, %s, %s, %s)',
                    (666, '936ce666-ff3b-4c7a-9674-367fe2120408', '2012-04-08 10:56:41.558922', 0, '{1a5dabbd-0e74-41da-b532-a364bb552cab}', '1.0.4.1')),),
