...
#==============================================================================
class TestPostgreSQLWebServiceBase(TestCase):
    ...
    def get_dummy_config(self):
        ...
        self.config_manager = get_standard_config_manager(
            service_classes=[CrashesReportSearchWebServiceBase],
        )
    ...
    def get_instance(self, config=None):
        ...
        """
        args = {
            "config": config or self.get_dummy_config()
        }
        return CrashesReportSearchWebServiceBase(**args)
...
class IntegrationTestBase(PostgreSQLWebServiceBase):
    ...
    #--------------------------------------------------------------------------
    @staticmethod
    def _insert_test_data(connection):
        # clear old data, just in case
        IntegrationTestBase._delete_test_data(connection)
        execute_no_results(
            connection,
            """
            INSERT INTO reports
    ...
    #--------------------------------------------------------------------------
    @staticmethod
    def _delete_test_data(connection):
        execute_no_results(
            connection,
    ...
    #--------------------------------------------------------------------------
    def test_utc(self):
        base = PostgreSQLWebServiceBase(config=self.config)
