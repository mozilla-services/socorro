...
from socorro.external.postgresql.crash_service import Crash
...
class IntegrationTestCrash(PostgreSQLTestCase):
    """Test socorro.external.postgresql.crash_service.Crash class. """
    ...
    def _insert_test_data(self, connection):
        ...
        execute_no_results(
            connection,
            "TRUNCATE reports_duplicates, reports CASCADE"
        )
        # Insert data
        ...
        execute_no_results(
            ...
            """
            INSERT INTO reports (
                id, signature, date_processed, uuid, url, email, success,
                addons_checked, exploitability
            )
            VALUES
            (
                1,
    ...
    def setUp(self):
        ...
        data. """
        super(IntegrationTestCrash, self).setUp(Crash)
