...
from socorro.external.postgresql.search_service import Search
...
class IntegrationTestSearch(PostgreSQLTestCase):
    """Test socorro.external.postgresql.search_service.Search class. """
    ...
    def setUp(self):
        ...
        data. """
        super(IntegrationTestSearch, self).setUp((Search, Util))
    ...
    def tearDown(self):
        ...
        self.transaction(
            execute_no_results,
            "TRUNCATE reports, plugins_reports, plugins CASCADE"
        )
