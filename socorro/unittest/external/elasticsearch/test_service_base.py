...
class IntegrationTestElasticSearchBase(TestCase):
    ...
    def _get_default_config(self):
        overrides = {
            ...
            'resource.elasticsearch.elasticsearch_emails_index':
                'socorro_integration_test',
        }
        cm = get_standard_config_manager(
            service_classes=ElasticSearchBase,
            overrides=overrides,
        )
...
class TestElasticSearchBase(TestCase):
    ...
    def get_dummy_config(self):
        ...
        overrides = {
            'resource.elasticsearch.elasticSearchHostname': 'localhost',
            'resource.elasticsearch.elasticSearchPort': 9200,
            'webapi.platforms': platforms,
            'webapi.non_release_channels': ['beta', 'aurora', 'nightly'],
