...
from socorro.external.happybase import hbase_client
from socorro.external.happybase.crash_data_service import CrashData
...
class TestIntegrationHBaseCrashData(TestCase):
    ...
    def setUp(self):
        ...
        super(TestIntegrationHBaseCrashData, self).setUp()
    ...
    #--------------------------------------------------------------------------
    def tearDown(self):
        super(TestIntegrationHBaseCrashData, self).tearDown()
        with self.config_manager.context() as config:
            connection = hbase_client.HBaseConnectionForCrashReports(
                config.resource.hbase.hbase_host,
                config.resource.hbase.hbase_port,
                config.resource.hbase.hbase_timeout
            )
