...
def get_standard_config_manager(
    ...
    if service_classes:
        ...
        for service_class in service_classes:
            ...
            # classes_in_namespaces converter defined in the middleware
...
#------------------------------------------------------------------------------
def get_config_manager_for_middleware(
    more_definitions=None,
    service_classes=None,
    overrides=None,
):
    if isinstance(more_definitions, Sequence):
        more_definitions = more_definitions.append(
            MiddlewareApp.get_required_config()
        )
    elif more_definitions is not None:
        more_definitions = [
            more_definitions,
        ...
        more_definitions = [MiddlewareApp.get_required_config()]
